...
function showCategory(category) {
    console.dir(products[category]);
    let arr = products[category];
    for (let i = 0; i < arr.length; i++) {
        getProductMarkup(arr[i]);
    };
}
...
function getProductMarkup(product) {
    productsEl.insertAdjacentHTML('beforeend', `<div class="product">
